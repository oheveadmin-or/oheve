...
export const ALL_STYLE_PRESETS: ThemePreset[] = [
  {
    ...
    description: 'Noir & blanc élégant : programme encadré de rayures CSS, countdown dramatique, photo, RSVP épuré',
    theme: {
      style: 'stripes-editorial',
      backgroundColor: '#F8F6F2',
      textColor: '#111111',
      primaryColor: '#111111',
      secondaryColor: '#3D2B1A',
  ...
  },
  {
    id: 'vintage-blue',
    label: '✦ Vintage Bleu',
    description: 'Bleu poussiéreux & ivoire, papeterie haut de gamme, invitation classique',
    theme: {
      style: 'vintage-blue',
      backgroundColor: '#F2EFE6',
      textColor: '#233853',
      primaryColor: '#233853',
      secondaryColor: '#4A6589',
      fontFamily: "'Playfair Display', 'Cormorant Garamond', Georgia, serif",
